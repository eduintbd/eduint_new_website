...
const FAQ_ITEMS = [
  {
    ...
    content: "Our AI analyzes your academic profile, including GPA, test scores, field of study, career goals, budget, and preferred countries. It then compares your profile against 140,000+ programs from 1,500+ universities to rank programs by compatibility and acceptance probability.",
  },
  {
  ...
  },
  {
    ...
    content: "We currently support programs in Australia, Canada, United States, United Kingdom, Germany, and Ireland. We're continuously expanding to more destinations.",
  },
  {
