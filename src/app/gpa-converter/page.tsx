  ...
  return (
    <div className="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-8">
      <div className="text-center mb-8">
        <div className="inline-flex items-center justify-center h-14 w-14 rounded-none bg-[#E0FE9C] text-black mb-4">
      ...
      <div className="mt-8 p-4 rounded-none bg-gray-50 dark:bg-gray-800 border border-gray-200 dark:border-gray-800">
        <h3 className="font-semibold text-sm text-gray-900 dark:text-gray-200 mb-2">About GPA Scales</h3>
