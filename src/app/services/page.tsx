    ...
    <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 py-12">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 gap-6 mb-16">
        {[
          ...
          return (
            <div key={stat.label} className="text-center p-4 rounded-xl bg-gray-50 dark:bg-gray-800">
          ...
          return (
            ...
            >
              <div className="flex-1">
                <div className={`inline-flex items-center justify-center h-12 w-12 rounded-xl ${service.color} text-white mb-4`}>
              ...
              <div className="flex-1 w-full h-48 rounded-xl bg-gradient-to-br from-gray-100 to-gray-200 dark:from-gray-800 dark:to-gray-700 flex items-center justify-center">
      ...
      {/* CTA */}
      <div className="text-center mt-16 p-8 rounded-2xl bg-gradient-to-r from-blue-600 to-blue-700 text-white">
        <h2 className="text-2xl font-bold mb-3">Ready to Start Your Journey?</h2>
        <p className="text-blue-100 mb-6">Get a free consultation with our expert counselors today.</p>
        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
          ...
          <Link
            href="/contact"
            className="inline-flex items-center px-6 py-3 border border-white/70 text-white font-medium rounded-lg hover:bg-white/10 transition-colors"
          >
            Contact Us
          </Link>
        </div>
